...
export const featuredWorks = [
  ...
  },
  {
    ...
    num: "02",
    name: "StockMate",
    headline: "주식 학습 및 모의투자 서비스",
    desc: [
      "주식 입문자가 개념을 학습하고 종목 정보를 확인한 뒤,",
      "모의투자까지 경험할 수 있도록 설계한 서비스입니다.",
    ],
    tags: ["서비스 기획", "팀 리딩", "UX", "QA", "베타테스트"],
    core: [
      "학습, 종목 정보, AI, 모의투자 등 다양한 기능을",
      "하나의 사용자 흐름으로 연결하는 데 집중했습니다.",
    ],
    images: [
